...
const fetchAll = async () => {
  ...
  const MATIERES = ["Mathématiques", "Physique", "SVT", "Histoire & Géo", "Français", "Anglais", "Arabe","Education Islamique", "Informatique & Programmation" ,"Philosophie"];
      ...
      >
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "2.5rem" }}>
          <div>
            ...
            <p style={{ color: "#718096", margin: "0.5rem 0 0" }}>Bienvenue dans votre espace d'administration</p>
          </div>
